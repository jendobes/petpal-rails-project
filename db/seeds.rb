...
Pet.create(name: 'Buddah', age: 1, bio: "Energetic Puppy", gender: "Male", species: "Dog", breed: "Mix", zip_code: 10001, kill_shelter: false, fosterer: false, adopter: true, shelter_id: 1)
Pet.create(name: 'Sparky', age: 9, bio: "Elderly cat needs a buddy", gender: "Male", species: "Cat", breed: "Long Haired", zip_code: 10022, kill_shelter: true, fosterer: false, adopter: true, shelter_id: 1)
...
Pet.create(name: 'Buddy', age: 10, bio: "Cute old man dog, low energy but cuddly", gender: "Male", species: "Dog", breed: "Golden Retriever", zip_code: 10003, kill_shelter: true, fosterer: true, adopter: true, shelter_id: 1)
Pet.create(name: 'Lady', age: 1, bio: "Peppy little pupper", gender: "Female", species: "Dog", breed: "bull dog", zip_code: 10004, kill_shelter: false, fosterer: false, adopter: true, shelter_id: 1)
...
Pet.create(name: 'Sunflower', age: 3, bio: "Loves to chase mice", gender: "Female", species: "Cat", breed: "tabby", zip_code: 10005, kill_shelter: true, fosterer: true, adopter: true, shelter_id: 1)
Pet.create(name: 'Mittens', age: 5, bio: "Will be your companion", gender: "Female", species: "Cat", breed: "siamese", zip_code: 10009, kill_shelter: false, fosterer: true, adopter: true, shelter_id: 1)
